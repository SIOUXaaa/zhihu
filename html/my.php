  ...
  <div class="fly-panel fly-panel-user" pad20>
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      <ul class="layui-tab-title" id="LAY_mine">
          ...
          $sql = "select  count(*) as number  from pl where uname='$name' order by id desc ";
          $rs = mysqli_query($conn,$sql);
          $res = mysqli_fetch_assoc($rs);

          ?>
        <li data-type="mine-jie" lay-id="index" class="layui-this">我发的帖（<span><?php echo $res['number'];?></span>）</li>
      </ul>
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
              ...
              ?>
            <li>
              <a class="jie-title" href="detail.php?id=<?php echo $res['id']?>" target="_blank"><?php echo $res['title']?></a>
              <i><?php echo $res['atime']?></i>
<!--              <a class="mine-edit" href="/jie/edit/8116">编辑</a>-->
              <em><?php echo $res['num']?></em>
            </li>
              <?php }?>
          </ul>
          <div id="LAY_page"></div>
