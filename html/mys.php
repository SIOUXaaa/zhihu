  ...
  <div class="fly-panel fly-panel-user" pad20>
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      <ul class="layui-tab-title" id="LAY_mine">
          ...
          $sql = "select  count(*) as number  from sc where uname='$name' order by id desc ";
          $rs = mysqli_query($conn,$sql);
          $res = mysqli_fetch_assoc($rs);

          ?>
        <li data-type="mine-jie" lay-id="index" class="layui-this">我收藏的贴（<span><?php echo $res['number']?></span>）</li>
      </ul>
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-tab-item layui-show">
          <ul class="mine-view jie-row">
              ...
              $sql1 = "select  *  from sc where uname='$name'";
              ...
              ?>
            <li>
              <a class="jie-title" href="detail.php?id=<?php echo $res['pl_id']?>" target="_blank"><?php echo $res['pl_title']?></a>
